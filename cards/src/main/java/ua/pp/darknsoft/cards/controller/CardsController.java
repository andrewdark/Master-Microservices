...
import ua.pp.darknsoft.cards.dto.CardsContactInfoRDto;
import ua.pp.darknsoft.cards.dto.ErrorResponseDto;
import ua.pp.darknsoft.cards.dto.ResponseDto;
import ua.pp.darknsoft.cards.service.ICardService;


/**
 * CardsController is a REST controller for Card operations.
 *
 * @author Andrew Dark
 * @since 0.1
 */
...
public class CardsController {
    ...
    private final CardsContactInfoRDto cardsContactInfoRDto;

    private final ICardService cardService;

    @Operation(
            summary = "Create Card REST API",
            description = "REST API to create new Card inside DarkyBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<CardsContactInfoRDto> getContactInfo() {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(cardsContactInfoRDto);
    }
}
