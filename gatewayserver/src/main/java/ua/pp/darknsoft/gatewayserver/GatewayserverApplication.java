...
public class GatewayserverApplication {
    ...
    @Bean
    public RouteLocator darkyBankRouteConfig(RouteLocatorBuilder routeLocatorBuilder) {
        return routeLocatorBuilder.routes()
                .route(p -> p
                        .path("/darkybank/accounts/**")
                        .filters(f -> f.rewritePath("/darkybank/accounts/(?<segment>.*)", "/${segment}")
                ...
                .route(p -> p
                        ...
                        .filters(f -> f.rewritePath("/darkybank/cards/(?<segment>.*)", "/${segment}")
                                .addResponseHeader("X-Response-Time", LocalDateTime.now().toString())
