 ...
 */
@Tag(
        name = "CRUD REST APIs for Accounts in DarkyBank",
        description = "CRUD REST APIs in DarkyBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside DarkyBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
