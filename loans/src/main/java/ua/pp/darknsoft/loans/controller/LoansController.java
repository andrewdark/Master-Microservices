...
public class LoansController {
    ...
    private final LoansContactInfoRDto loansContactInfoRDto;
    ...
    public ResponseEntity<LoansContactInfoRDto> getContactInfo() {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(loansContactInfoRDto);
    }
